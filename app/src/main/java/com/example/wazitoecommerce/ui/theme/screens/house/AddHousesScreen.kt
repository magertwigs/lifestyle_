...
fun AddHousesScreen(navController:NavHostController){
    Column(
        ...
        var houseOwner by remember { mutableStateOf("") }
        ...
        ImagePicker(modifier,context, navController, houseOwner.trim(), houseLocation.trim(), housePrice.trim())
...
@Composable
fun ImagePicker(modifier: Modifier = Modifier, context: Context,navController: NavHostController, owner:String, location:String, price:String) {
    ...
    Column(modifier = modifier,) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                houseRepository.uploadHouse(owner, location, price,imageUri!!)
